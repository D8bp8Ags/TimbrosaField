"""Unit test for Fase 6: typed Detection contract in ai/contracts.py.
...
produce (see ai_backends/*.py), and that AiBackend is still importable
via the new contracts module without moving the original file.
"""

from __future__ import annotations

from ai.contracts import AiBackend, Detection
...
def test_aibackend_still_importable_via_contracts_module():
    from ai_backends.base import AiBackend as OriginalAiBackend
