"""Centralized keyboard shortcut management for the TimbrosaField application."""
...
class GlobalShortcutManager:
    ...
    def setup_all_shortcuts(self):
        ...
        self.add_command_shortcut(
            "Ctrl+I", "file_commands", "batch_import_files", "Batch Import Files"
        )  # I = Import
        ...
        self.add_command_shortcut(
            "Ctrl+Shift+R", "edit_commands", "reset_defaults", "Reset to Defaults"
        )  # R = Reset
        ...
        self.add_command_shortcut(
            "Ctrl+U", "analysis_commands", "show_cue_analysis", "Cue Point Analysis"
        )  # U = cUe points
        ...
        self.add_command_shortcut(
            "F12", "help_commands", "show_about", "About Application"
        )  # F12 often used for about
    ...
    def add_command_shortcut(
        ...
        """Register a keyboard shortcut that executes a cmd via the cmd interface.
    ...
    def get_shortcut_for_command(self, command_group, command_name):
        ...
        for key_sequence, shortcut_info in self.shortcuts.items():
            if (
                shortcut_info['command_group'] == command_group
                and shortcut_info['command_name'] == command_name
            ):
                return key_sequence
        return ""
