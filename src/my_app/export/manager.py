...
from my_app.export.ableton_generator import AbletonLiveSetGeneratorV3Optimized
from my_app.ui.dialogs.analytics_dashboard import AnalyticsDashboard
...
class AbletonExporter:
    ...
    def is_ableton_export_available(self) -> bool:
        ...
        """
        try:
            import my_app.export.ableton_generator  # noqa: F401
        except ImportError:
            return False
