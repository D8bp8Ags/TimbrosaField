    ...
    def save_template(self):
        ...
        try:
            ...
            if is_rename and old_template_name in self.template_manager.templates:
                old_template_data = self.template_manager.templates[
                    old_template_name
                ].copy()
            ...
            if is_rename and old_template_name in self.template_manager.templates:
                ...
                logger.info(f"Template renamed: {old_template_name} -> {name}")
            ...
            if is_rename and old_template_data and old_template_name:
                ...
                logger.warning(
                    f"Rolled back failed rename operation for '{old_template_name}'"
                )
