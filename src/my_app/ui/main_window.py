"""MainWindow for the Field Recorder Analyzer application.

Wires together managers (file, export, dialogs, UI, etc.) and the central
WavViewer. Extracted from main.py (Fase 7) — main.py now only contains the
application bootstrap/entrypoint (QApplication setup, splash screen,
...
from my_app.ai.ui.analysis_dialog import AiAnalysisDialog
from my_app.ui.dialogs.batch_tag_editor import BatchTagEditor
from my_app.ui.dialogs.cuepoints import CuePointsAnalysisDialog
from my_app.photo_gps_matcher import PhotoGpsMatcher
from my_app.ui.dialogs.dialog_manager import DialogManager
from my_app.export.manager import ExportManagerInterface
from my_app.files.manager import FileManagerInterface
from my_app.ui.shortcuts import GlobalShortcutManager
from my_app.ui.menus import MenuBarManager
...
from my_app.ui.settings import SettingsManager
from my_app.tags.templates import TemplateManager
from my_app.tags.ui import TemplateManagerDialog
from my_app.ui.components import ApplicationStylist, UIComponentManager
from my_app.user_config_manager import TagEditor
from my_app.ui.waveform.viewer import WavViewer
